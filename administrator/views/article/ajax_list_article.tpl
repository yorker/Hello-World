	...
	<tbody>
		...
		<tr class="row<{$smarty.foreach.fname.iteration%2}>">
			...
			<td>
				...
				<{if $itm.cover_img}>
					&nbsp;<a href="javascript:void(0)" onmouseover="showImg('<{$upload_url}><{$itm.cover_img}>', 100)" onmouseout="nd()"><img src="images/picflag.gif" border="0" title="<{$lang.has_cover_img}>"/></a>
				<{/if}>
				<{if $itm.link}>
