...
KE.setting = {
	...
	items : [
		...
		'flash', 'media', 'advtable', 'hr', 'emoticons', 'link', 'unlink', 'breakpage', '|', 'about'
	],
	colorTable : [
...
KE.selection = function(doc) {
	...
	this.init = function() {
		var sel = win && win.getSelection ? win.getSelection() : doc.selection;
		var range;
		try {
...
KE.plugin.breakpage = {
	click : function(id) {
		KE.insertHtml(id, '#p#BreakPage#e#');
	}
};
