...
for($i = 0; $i < count($this->data); $i++)
{
	...
	# top shadow
	imagefilledpolygon($this->chart, array($columnx, $columny, $columnx + $shadow, $columny - $shadow, $columnx + $shadow + $column_width, $columny - $shadow, $columnx + $column_width, $columny), 4, $this->colors['list'][$i * 2 + 5]);
	# right shadow
	imagefilledpolygon($this->chart, array($columnx + $column_width, $columny, $columnx + $shadow + $column_width, $columny - $shadow, $columnx + $shadow + $column_width, $starty - $shadow, $columnx + $column_width, $starty - 1), 4, $this->colors['list'][$i * 2 + 5]);
	# column border
