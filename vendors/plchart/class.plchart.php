...
/**
  ...
  *
  * Class for making charts: 2D/3D Pie, 2D/3D (Group/Percent)Column, single/multiple Line,
  * (Single/Multiple)Radar, Scatter, Bubble, Stock(4 types). Enjoy it!
  *
  * Be easy to make your own charts from now! 
  *
  * English Manual : http://www.plchart.net/index.php/PLChart:Manual
  * Get help from : http://www.plchart.net
  *
  * ====================================================================  
...
class plchart
{
	...
	{
		include dirname(__FILE__) . DIRECTORY_SEPARATOR . 'graphs' . DIRECTORY_SEPARATOR . 'functions.php';
		require dirname(__FILE__) . DIRECTORY_SEPARATOR . 'graphs' . DIRECTORY_SEPARATOR . $this->type.'.graph.php';
	}
