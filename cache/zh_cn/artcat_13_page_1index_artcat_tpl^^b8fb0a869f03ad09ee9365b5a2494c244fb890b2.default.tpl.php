...
<title>JAVA程序设计-傻瓜的梦工场-个人空间-Speed</title>
</head>
<body>
<div id="container">
    ...
    <div id="content">
		<div id="nav_position"><ul class="clearfix"><li><a href="index.html">首页</a></li><li>&gt;&gt;</li><li><a href="Index/artcat/19">文章</a></li><li>&gt;&gt;</li><li class="last"><a href="Index/artcat/13">JAVA程序设计</a></li></lu></div>
...
<div class="cat_article">
	<h2>JAVA程序设计</h2>
			<ul>
							<li class="clearfix">
					<div class="fl">
						<a href="Index/artcat/13"><span>[</span>JAVA程序设计<span>]</span></a>&nbsp;<a href="Index/article/70" title="JAVA基础题集">JAVA基础题集</a>
					</div>
					<div class="fr">
						2010-09-26
					</div>
