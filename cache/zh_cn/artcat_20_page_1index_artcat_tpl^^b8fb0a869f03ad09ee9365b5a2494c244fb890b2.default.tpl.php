...
<title>Windows相关-傻瓜的梦工场-个人空间-Speed</title>
</head>
<body>
<div id="container">
    ...
    <div id="content">
		<div id="nav_position"><ul class="clearfix"><li><a href="index.html">首页</a></li><li>&gt;&gt;</li><li><a href="Index/artcat/19">文章</a></li><li>&gt;&gt;</li><li class="last"><a href="Index/artcat/20">Windows相关</a></li></lu></div>
...
<div class="cat_article">
	<h2>Windows相关</h2>
			<ul>
							<li class="clearfix">
					<div class="fl">
						<a href="Index/artcat/20"><span>[</span>Windows相关<span>]</span></a>&nbsp;<a href="Index/article/97" title="Windows最常用的运行命令集">Windows最常用的运行命令集</a>
					</div>
					<div class="fr">
						2010-09-26
					</div>
							...
							<li class="clearfix">
					<div class="fl">
						<a href="Index/artcat/20"><span>[</span>Windows相关<span>]</span></a>&nbsp;<a href="Index/article/98" title="系统清理">系统清理</a>
					</div>
					<div class="fr">
						2010-09-26
					</div>
