...
<title>平面设计-傻瓜的梦工场-个人空间-Speed</title>
</head>
<body>
<div id="container">
    ...
    <div id="content">
		<div id="nav_position"><ul class="clearfix"><li><a href="index.html">首页</a></li><li>&gt;&gt;</li><li><a href="Index/artcat/19">文章</a></li><li>&gt;&gt;</li><li class="last"><a href="Index/artcat/26">平面设计</a></li></lu></div>
...
<div class="cat_article">
	<h2>平面设计</h2>
			<ul>
							<li class="clearfix">
					<div class="fl">
						<a href="Index/artcat/26"><span>[</span>平面设计<span>]</span></a>&nbsp;<a href="Index/article/139" title="PhotoShop批量缩小图片尺寸">PhotoShop批量缩小图片尺寸</a>
					</div>
					<div class="fr">
						2010-11-23
					</div>
		...
		<div id="pagination">&nbsp;&nbsp;&nbsp;&nbsp;共1页（1-1/1）</div>
	</div>
