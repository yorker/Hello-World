...
<div class="cat_article">
	<h2>文章</h2>
			<ul>
							<li class="clearfix">
					<div class="fl">
						<a href="Index/artcat/14"><span>[</span>PHP程序设计<span>]</span></a>&nbsp;<a href="Index/article/78" title="PHP计算中英文字符的长度函数">PHP计算中英文字符的长度函数</a>
					</div>
					<div class="fr">
						2010-09-26
					</div>
							...
							<li class="clearfix">
					<div class="fl">
						<a href="Index/artcat/14"><span>[</span>PHP程序设计<span>]</span></a>&nbsp;<a href="Index/article/79" title="utf8中英文字符截取">utf8中英文字符截取</a>
					</div>
					<div class="fr">
						2010-09-26
					</div>
							...
							<li class="clearfix">
					<div class="fl">
						<a href="Index/artcat/14"><span>[</span>PHP程序设计<span>]</span></a>&nbsp;<a href="Index/article/80" title="E-mail正则表达式">E-mail正则表达式</a>
					</div>
					<div class="fr">
						2010-09-26
					</div>
							...
							<li class="clearfix">
					<div class="fl">
						<a href="Index/artcat/16"><span>[</span>JS&网页实现<span>]</span></a>&nbsp;<a href="Index/article/84" title="attachEvent() 与addEventListener()绑定事件">attachEvent() 与addEventListener()绑定事件</a>
					</div>
					<div class="fr">
						2010-09-26
					</div>
		...
		<div id="pagination"><span class="first"><a href="Index/artcat/19?page=1">&nbsp;</a></span><span class="prev"><a href="Index/artcat/19?page=10">&nbsp;</a></span><span class="number"><a href="Index/artcat/19?page=7">[7]</a></span><span class="number"><a href="Index/artcat/19?page=8">[8]</a></span><span class="number"><a href="Index/artcat/19?page=9">[9]</a></span><span class="number"><a href="Index/artcat/19?page=10">[10]</a></span><span class="number"><strong>[11]</strong></span>&nbsp;&nbsp;&nbsp;共11页（111-114/114）</div>
	</div>
